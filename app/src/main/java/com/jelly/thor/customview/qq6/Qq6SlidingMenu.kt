package com.jelly.thor.customview.qq6
...
/**
 * 类描述：仿酷狗侧边栏-基础上改造成qq6.0效果<br/>
 * 创建人：吴冬冬<br/>
 * 创建时间：2019/5/30 13:12 <br/>
 */
class Qq6SlidingMenu @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    init {
        //初始化自定义属性
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.Qq6SlidingMenu)

        rightMargin = typedArray.getDimension(R.styleable.Qq6SlidingMenu_rightPadding, dp2px(20).toFloat()).toInt()
